...
function setupUserMenu(header, userData) {
  ...
  userMenu.innerHTML = `
    ...
    <div class="user-dropdown">
      ...
      <button type="button" class="dropdown-link logout-btn" style="width: 100%; text-align: left; background: none; border: none; cursor: pointer; color: #ff4d4f;"><i class="fas fa-sign-out-alt"></i> Đăng xuất</button>
    </div>
  `;
